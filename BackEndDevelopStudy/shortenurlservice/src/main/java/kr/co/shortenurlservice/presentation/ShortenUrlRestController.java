...
public class ShortenUrlRestController {
    ...
    public ResponseEntity<?> redirectShortenUrl(@PathVariable(name = "shortenUrlKey") String shortenUrlKey) throws URISyntaxException {
    ...
    public ResponseEntity<?> getShortenUrlInformation(@PathVariable(name = "shortenUrlKey") String shortenUrlKey) {
